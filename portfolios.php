...
<body>
    <section class="portfolio-section">
        <header class="portfolios">
            ...
            <p class="miring wow fadeIn work-medium visible-md visible-lg "><?= $_GET['kategori'] ?></p>
        ...
        <div class="portfolio-container" id='portfolio'>
            <div class="container-fluid">
                <div class="row portfolios-wrapper">
                    ...
                    ?>
                    <div class="portfolio-item col-lg-6 text-light wow fadeInUp" style="background-image: linear-gradient(#2b262384,#2b262384),url(<?='assets/img/portofolio/'.$id_project.'/'.$array_imgs[0];?>);">
                        <div class="portfolio-content wow fadeInRight">
                            <span><?= $kategori ?></span>
