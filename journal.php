...
<body>
    <section class="journal-section">
        ...
        <p class="miring wow fadeIn work-medium visible-md visible-lg ">Journal</p>
                ...
                <div class="row journals-wrapper">
                    <?php
                        ...
                        while($data=mysqli_fetch_array($query)){
                          ...
                          $array_imgs = explode(",", $img_files);
                    ?>
                    <div class="journal-item col-lg-6 text-light wow fadeInUp" style="background-image: linear-gradient(#2b262384,#2b262384),url(<?='assets/img/journal/'.$id_journal.'/'.$array_imgs[0];?>);">
                        <div class="journal-content wow fadeInLeft">
                            <span><?= $kategori ?></span>
