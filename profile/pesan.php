    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tabel Pesan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                  ...
                  <div class="row align-items-center justify-content-between w-100">
                    ...
                    <div class="col-2 text-end p-0">
                      <!-- <form action="./kelola_project.php" method="get">
                        ...
                        <button type="submit" class="btn btn-success mb-3"><i class="bi bi-file-earmark-plus-fill"></i> Tambah Project</button>
                      </form> -->
                    </div>
                  </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row gap-2">
                            <div class="col-2">
                              <form action="./kelola_pesan.php" method="get">
                                <input type="hidden" name="id" value=<?= $id_pesan ?> />
