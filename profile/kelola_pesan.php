...
<head>
  ...
  <title>Halaman Admin | Pesan - Agit & Co</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Tabel Pesan</li>
              ...
              if(isset($_GET['kelola'])){
                ...
                if($_GET['kelola'] == 'tambah'){
                  ...
                  $kategori     ="";
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM pesan WHERE id_pesan='".$_GET['id']."'");
            ...
            <div class="col">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  ...
                  <form action="../model/proses_contact.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" value=<?= $_GET['kelola'] ?> name="kelola" />
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold">Id Pesan</label>
                      <input type="text" class="form-control bg-dark-light" name="id_pesan" id="projectName" value=<?= $id_pesan ?> readonly/>
