    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tabel Journals</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                  ...
                  <div class="row align-items-center justify-content-between w-100">
                    ...
                    <div class="col-2 text-end p-0">
                      <form action="./form_journal.php" method="get">
                        ...
                        <button type="submit" class="btn btn-success mb-3"><i class="bi bi-file-earmark-plus-fill"></i> Tambah Journal</button>
                      </form>
                    </div>
                  </div>
