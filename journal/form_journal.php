...
<body>
  ...
  <main id="main" class="main mt-5 pt-5" style="margin: 0;">
    ...
    <div class="pagetitle">
      <h1>Kelola Journal</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item ">Home</li>
          <li class="breadcrumb-item ">Journals</li>
          <li class="breadcrumb-item ">Tabel Journals</li>
          <li class="breadcrumb-item active">Kelola Journals</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <div class="row py-4">
                    <div class="col">
                      <h2 class="fw-bold mb-1" style="text-transform: capitalize;"><?= $_GET['kelola'] ?> Journal</h2>
